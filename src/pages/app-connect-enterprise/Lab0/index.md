...
3. You might get the following warning if the flow had not been deployed :
   ...
   Click **OK**.
4. The Application must be deployed to the **default** Integration Server of **POTNODE**(In the previous lab you have the instructions on how to create a new Integration Server or Integration Node from Integration Explorer). This will be done automatically for you by the Flow Exerciser:
